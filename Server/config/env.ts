 ...
 * particular would otherwise make jwt.sign throw once per request.
 */
...
// Safe after the check above, but TypeScript can't see that across the
// process.exit, so assert once here rather than at every use site.
